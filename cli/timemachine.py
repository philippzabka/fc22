...
"""
Example call: python __main__.py timemachine restore gossip-20210104.gsp.bz2 1607768139 --fmt=graphml
"""
...
def restore(dataset, timestamp=None, fmt='dot'):
    ...
    if fmt == 'dot':
        write_dot(g, "/Users/zmaster/PycharmProjects/topology/graphs/" + str(timestamp) + "_lngraph.dot")
        # print(nx.nx_pydot.to_pydot(g))

    elif fmt == 'gml':
        nx.write_gml(g, "/Users/zmaster/PycharmProjects/topology/graphs/" + str(timestamp) + "_lngraph.gml")
        # for line in nx.generate_gml(g):
        #     print(line)

    elif fmt == 'graphml':
        nx.write_graphml(g, "/Users/zmaster/PycharmProjects/topology/graphs/" + str(timestamp) + "_lngraph.graphml")
